        ...
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              console.log('❌ Error during profile logout:', error);
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoContent}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{rider.phone || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
              ...
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{rider.vehicle_type || 'N/A'}</Text>
              </View>
              <View style={styles.infoRow}>
                <Text style={styles.infoLabel}>License Number:</Text>
                <Text style={styles.infoValue}>{rider.license_number || 'N/A'}</Text>
              </View>
            </View>
          </View>
