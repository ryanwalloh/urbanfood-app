...
const MainPage = ({ user, onLogout }) => {
  ...
  const searchPaddingAnim = useRef(new Animated.Value(0)).current;
  const searchMarginAnim = useRef(new Animated.Value(-30)).current;
  ...
  const handleScroll = (event) => {
    ...
    // Hero height is approximately 380px, search overlaps at ~350px
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      >
        ...
        <View style={[styles.searchContainer, isScrolled && styles.searchContainerScrolled]}>
          <View style={[styles.searchWrapper, isScrolled && styles.searchWrapperScrolled]}>
...
const styles = StyleSheet.create({
  ...
  searchContainerScrolled: {
    paddingTop: 60, // Add top padding when scrolled
  },
  searchWrapper: {
    paddingHorizontal: 20,
    marginTop: -30, // Negative margin to create overlap effect
  },
  searchWrapperScrolled: {
    marginTop: 0, // Remove negative margin when scrolled
  },
