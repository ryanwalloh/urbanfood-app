...
import { View, Text, Image, TouchableOpacity, StyleSheet, ScrollView, Dimensions, Modal, TextInput, Alert, ActivityIndicator } from 'react-native';
        ...
        <View style={styles.modalContainer}>
          ...
          {editingAddress && (
            <View style={styles.mapWrapper}>
              ...
              <View style={styles.markerFixed}>
                <View style={[styles.markerContainer, isMapMoving && styles.markerMoving]}>
          ...
          <View style={styles.modalContent}>
            ...
            <View style={styles.addressDisplayContainer}>
              <Text style={styles.addressDisplayLabel}>Address (Plus Code)</Text>
