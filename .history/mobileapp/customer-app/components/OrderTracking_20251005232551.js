      ...
      >
        ...
        <View style={styles.progressContainer}>
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {statusContent.activeBar === 0 && currentStatus === 'pending' && (
              <Animated.View
                style={[
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {statusContent.activeBar === 1 && currentStatus === 'preparing' && (
              <Animated.View
                style={[
                  styles.progressBarActive,
                  {
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {statusContent.activeBar === 2 && currentStatus === 'ready' && (
              <Animated.View
                style={[
                  styles.progressBarActive,
                  {
          ...
          {statusContent.activeBar === 3 && currentStatus === 'otw' && (
            <Animated.View
              style={[
                styles.progressBarActive,
                {
