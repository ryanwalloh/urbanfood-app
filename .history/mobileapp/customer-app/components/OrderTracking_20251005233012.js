      ...
      >
        ...
        <View style={styles.progressContainer}>
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {currentStatus === 'pending' && statusContent.activeBar === 0 && (
              <Animated.View
                style={[
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {currentStatus === 'preparing' && statusContent.activeBar === 1 && (
              <Animated.View
                style={[
                  styles.progressBarActive,
                  {
          ...
          <View style={styles.progressBarWrapper}>
            ...
            {currentStatus === 'ready' && statusContent.activeBar === 2 && (
              <Animated.View
                style={[
                  styles.progressBarActive,
                  {
          ...
          {currentStatus === 'otw' && statusContent.activeBar === 3 && (
            <Animated.View
              style={[
                styles.progressBarActive,
                {
