  ...
  return (
    <View style={styles.createContainer}>
      ...
      <MapView
        ...
        rotateEnabled={false}
      >
        {/* Map Marker with bouncing animation */}
        <Marker
          coordinate={{
        ...
        >
          ...
          >
            {/* Default red marker icon will be used */}
          </Animated.View>
        </Marker>
      </MapView>

      {/* Center Marker Shadow */}
      <View style={styles.markerShadowContainer} pointerEvents="none">
        <Animated.View 
          style={[
            styles.markerShadow,
            {
      ...
      <Animated.View style={[
        ...
        <View style={styles.welcomeContainer}>
          ...
          <Text style={styles.subtitle}>Tap on the map to select your location</Text>
        </View>
