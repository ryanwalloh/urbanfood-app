...
const Checkout = ({ cartItems, restaurant, user, onBack, onPlaceOrder }) => {
  ...
  const handleSavePersonalDetails = async () => {
    // Validate fields
    if (!personalDetails.firstName || !personalDetails.lastName || !personalDetails.phone) {
    ...
    try {
      ...
      // Here you would call an API to update user details
      // const result = await apiService.updateUserDetails(personalDetails);
  ...
  // Cancel editing personal details
  const handleCancelEditPersonalDetails = () => {
          ...
          {!isEditingPersonalDetails ? (
            ...
            <>
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{personalDetails.email || 'Not set'}</Text>
              </View>
              <View style={styles.detailRow}>
              ...
              <View style={styles.detailRow}>
                ...
                <Text style={styles.detailValue}>{personalDetails.phone || 'Not set'}</Text>
              </View>
            </>
          ) : (
            /* Edit Form View */
              ...
              <View style={styles.buttonContainer}>
                <View style={styles.buttonRow}>
                  <TouchableOpacity 
                    ...
                    onPress={handleCancelEditPersonalDetails}
                  >
