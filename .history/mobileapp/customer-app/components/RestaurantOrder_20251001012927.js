  ...
  return (
    <View style={styles.container}>
      <ScrollView 
        ...
        stickyHeaderIndices={[1]} // Make the sticky container (index 1) sticky
      >
        {/* Restaurant Header */}
        ...
        <View style={styles.productsGrid}>
          {loading ? (
            ...
            products.map((product, index) => (
              <TouchableOpacity key={product.id || index} style={styles.productCard}>
          ...
          <TouchableOpacity style={styles.floatingCartButton}>
            <View style={styles.floatingCartContent}>
              ...
              <Text style={styles.floatingCartText}>
                View Cart <Text style={styles.floatingCartCount}>({cartItems.reduce((total, item) => total + item.quantity, 0)} Item{cartItems.reduce((total, item) => total + item.quantity, 0) !== 1 ? 's' : ''} Added)</Text>
              </Text>
            </View>
          </TouchableOpacity>
        </View>
