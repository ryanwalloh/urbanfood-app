...
const RestaurantOrder = ({ restaurant, onBack }) => {
  ...
  const products = [
    { id: 1, name: 'Chicken Burger', price: '₱120', image: require('../assets/mock-product.png') },
    { id: 2, name: 'Beef Steak', price: '₱250', image: require('../assets/mock-product.png') },
    { id: 3, name: 'Fish Fillet', price: '₱180', image: require('../assets/mock-product.png') },
    { id: 4, name: 'Pasta Carbonara', price: '₱150', image: require('../assets/mock-product.png') },
    { id: 5, name: 'Caesar Salad', price: '₱100', image: require('../assets/mock-product.png') },
    { id: 6, name: 'Chocolate Cake', price: '₱80', image: require('../assets/mock-product.png') },
  ];
