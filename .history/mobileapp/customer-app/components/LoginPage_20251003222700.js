  ...
  useEffect(() => {
    ...
    const startBounceLoop = () => {
      createBounceAnimation().start(() => {
        ...
        setTimeout(startBounceLoop, 2000); // Wait 2 seconds before next bounce
      });
    };

    // Start the animation after a short delay
    const timer = setTimeout(startBounceLoop, 1500);
    ...
    <View style={styles.loginContainer}>
      ...
      <View style={styles.backgroundTextContainer}>
        <Text style={styles.backgroundText}>
          It's the <View style={styles.highlightedTextContainer}>
            <Text style={styles.highlightedText}>food</Text>
            <Animated.View 
              style={[
                styles.shineOverlay,
                {
