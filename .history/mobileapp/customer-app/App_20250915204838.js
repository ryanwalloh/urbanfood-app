...
export default function App() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      // First, animate logo scale and position
      Animated.parallel([
        ...
        // After logo animation completes, hide landing page and show login page
        setShowLanding(false);
        setShowLogin(true);
        
        // Fade in login page with ease-in animation
