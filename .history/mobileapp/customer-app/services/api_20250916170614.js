...
let cachedWorkingUrl = 'http://172.20.10.5:8000'; // Set the known working URL as default
...
const testMultipleUrls = async () => {
  ...
  const urls = [
    ...
    'http://172.20.10.5:8000',  // Your current IP address
  ];
  ...
  testConnection: async () => {
    ...
    if (!workingUrl) {
      return {
        ...
        details: {
          testedUrls: ['http://10.0.2.2:8000', 'http://127.0.0.1:8000', 'http://localhost:8000', 'http://172.20.10.5:8000'],
