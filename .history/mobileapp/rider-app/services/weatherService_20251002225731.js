...
export const weatherService = {
  ...
  // Map Open-Meteo weather codes to our system
  mapOpenMeteoWeatherCode: (openMeteoCode) => {
    ...
    return codeMap[openMeteoCode] || 2; // Default to partly cloudy
  },

  // Map OpenWeatherMap weather codes to our system (fallback)
