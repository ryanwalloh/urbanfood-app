...
export const weatherService = {
  ...
  getWeatherData: async (latitude, longitude) => {
    try {
      console.log('🌤️ Fetching real-time weather data from OpenWeatherMap for:', latitude, longitude);
      
      // Check if API key is configured
      if (OPENWEATHER_API_KEY === 'YOUR_OPENWEATHER_API_KEY_HERE') {
        throw new Error('OpenWeatherMap API key not configured. Please get a free API key from https://openweathermap.org/api');
      }
