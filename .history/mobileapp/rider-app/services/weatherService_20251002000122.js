// Weather service using Google Weather API (OpenWeatherMap)
...
export const weatherService = {
  ...
  getWeatherData: async (latitude, longitude) => {
    try {
      console.log('🌤️ Fetching weather data from Google API for:', latitude, longitude);
      ...
      // Fallback to local data if Google API fails
  ...
  // Fallback weather data for Iligan City (if Google API fails)
