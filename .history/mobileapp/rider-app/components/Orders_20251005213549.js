...
const Orders = ({ onBack }) => {
  ...
  const handleAcceptOrder = async (orderId) => {
    ...
    try {
      ...
      if (!hasPermission) {
        Alert.alert('Permission Required', 'Location permission is required to accept orders.');
        return;
      }
            ...
            <View style={styles.earningsContainer}>
              ...
              >
                <Image 
                  ...
                  style={[
                    styles.riderIcon,
                    (acceptingOrderId === order.order_id || acceptingOrderId) && styles.riderIconDisabled
                  ]}
                  resizeMode="contain"
                />
                <Text style={[
