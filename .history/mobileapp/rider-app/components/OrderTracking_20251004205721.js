...
const styles = StyleSheet.create({
  ...
  contentContainer: {
    ...
    left: 0,
    right: 0,
    backgroundColor: theme === 'night' ? '#111418' : '#FFFFFF',
  ...
  orderNumberLabel: {
    fontSize: 16,
    fontFamily: 'Nexa-ExtraLight',
    color: theme === 'night' ? '#A9B2BC' : '#666666',
  },
  orderNumberValue: {
    fontSize: 18,
    fontFamily: 'Nexa-Heavy',
    color: theme === 'night' ? '#FFFFFF' : '#1A1A1A',
  },
  callingCard: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  progressGuide: {
    backgroundColor: theme === 'night' ? '#151A20' : '#FFFFFF',
    padding: 20,
    borderRadius: 12,
    marginBottom: 20,
    shadowColor: '#000',
  ...
  deliveryTypeContainer: {
    backgroundColor: theme === 'night' ? '#0F1419' : '#1A1A1A',
    padding: 10,
    paddingHorizontal: 20,
    borderRadius: 12,
    marginBottom: 16,
