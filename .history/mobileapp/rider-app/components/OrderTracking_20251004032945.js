    ...
    return (
      <View style={styles.content}>
        ...
        <View style={styles.orderHeader}>
          <Text style={styles.orderTitle}>Order #{orderDetails.id || orderDetails.order_id}</Text>
          <Text style={styles.orderToken}>Token: {orderDetails.token_number}</Text>
        ...
        <View style={styles.progressSection}>
          ...
          <View style={styles.progressGuide}>
            ...
            <View style={styles.progressItem}>
              ...
              <View style={styles.progressTextContainer}>
                <Text style={styles.progressText}>{orderDetails.restaurant?.name || 'Restaurant'}</Text>
                <View style={styles.horizontalSeparator} />
              </View>
            </View>
            ...
            <View style={styles.progressItem}>
              ...
              <View style={styles.progressTextContainer}>
                <Text style={styles.progressText}>{orderDetails.customer?.username || 'Customer'}</Text>
              </View>
            </View>
          </View>
        </View>
