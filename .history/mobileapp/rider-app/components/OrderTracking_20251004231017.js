...
const OrderTracking = ({ orderId, onBack }) => {
  ...
  const AWS_CONFIG = {
    accessKey: 'AKIA5RA7TEOC2ZAU5MG2',
    secretKey: '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',
  ...
  const handleUploadPhoto = async () => {
    ...
    try {
      ...
      // Read file as base64
      const fileContent = await FileSystem.readAsStringAsync(proofOfDeliveryImage.uri, {
