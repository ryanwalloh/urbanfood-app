    ...
    return (
      <View style={styles.content}>
        ...
        <View style={styles.orderHeader}>
          ...
          <Text style={styles.orderStatus}>Status: On The Way</Text>
        </View>
        ...
        <View style={styles.infoSection}>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{orderDetails.customer_phone || 'N/A'}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Restaurant:</Text>
              <Text style={styles.infoValue}>{orderDetails.restaurant_name || 'N/A'}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Restaurant Location:</Text>
              <Text style={styles.infoValue}>{orderDetails.restaurant_street}, {orderDetails.restaurant_barangay}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>Customer Location:</Text>
              <Text style={styles.infoValue}>{orderDetails.customer_street}, {orderDetails.customer_barangay}</Text>
            </View>
          </View>
        </View>

        {/* Order Items - Not available in current API response */}
        <View style={styles.itemsSection}>
          <Text style={styles.sectionTitle}>Order Items</Text>
          <View style={styles.itemsCard}>
            <Text style={styles.noItemsText}>Order items not available in current API response</Text>
          </View>
        </View>
