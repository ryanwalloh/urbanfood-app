...
const styles = StyleSheet.create({
  ...
  // Weather Loading Circle Styles
  weatherLoadingContainer: {
    alignItems: 'center',
    justifyContent: 'center',
    minHeight: 80,
  },
  weatherLoadingCircle: {
    width: 40,
    height: 40,
    borderRadius: 20,
    borderWidth: 3,
