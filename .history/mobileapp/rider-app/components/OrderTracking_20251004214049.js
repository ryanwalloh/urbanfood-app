        ...
        <View style={styles.mapControls}>
          <TouchableOpacity 
            ...
            onPress={() => {
              ...
              if (riderLocation) {
                setRegion({
                  latitude: riderLocation.latitude + (region.latitudeDelta * 0.5 * -0.5), // Keep rider at top
          ...
          <TouchableOpacity 
            ...
            onPress={() => {
              ...
              if (riderLocation) {
                setRegion({
                  latitude: riderLocation.latitude + (region.latitudeDelta * 2 * -0.5), // Keep rider at top
                  longitude: riderLocation.longitude,
