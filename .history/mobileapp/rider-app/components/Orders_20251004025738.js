        ...
        {isExpanded && (
          <View style={styles.expandedDetails}>
            ...
            <View style={styles.amountSummary}>
              ...
              {/* Delivery Fee and Restaurant Bill - Two Tiles */}
              <View style={styles.amountRow}>
                ...
                <View style={styles.amountTile}>
                  <Text style={styles.amountLabel}>Restaurant Bill</Text>
                  <Text style={styles.amountValue}>₱{order.subtotal}</Text>
                </View>
              </View>
            </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.guideContainer}>
        <View style={[styles.guideItem, styles.orderNumberGuide]}>
          <Text style={styles.guideText}>Order #</Text>
        </View>
