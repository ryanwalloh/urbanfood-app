        ...
        >
          ...
          {riderLocation && (
            <Marker
              ...
              title="Your Location"
              anchor={{ x: 0.5, y: 1 }}
              image={require('../assets/ridermarker.png')}
              icon={require('../assets/ridermarker.png')}
            />
          )}
          ...
          {restaurantLocation && (
            <Marker
              ...
              title="Restaurant"
              anchor={{ x: 0.5, y: 1 }}
              image={require('../assets/restaurantmarker.png')}
              icon={require('../assets/restaurantmarker.png')}
            />
          )}
          ...
          {customerLocation && (
            <Marker
              ...
              title="Customer"
              anchor={{ x: 0.5, y: 1 }}
              image={require('../assets/customermarker.png')}
              icon={require('../assets/customermarker.png')}
            />
          )}
        </MapView>
