                ...
                <View style={styles.transactionItem}>
                  ...
                  <View style={styles.transactionContent}>
                    ...
                    <Text style={styles.assignmentAddress}>
                      {assignment.barangay ? `${(assignment.plus_code || extractPlusCode(assignment.street || assignment.address)) ? `${assignment.plus_code || extractPlusCode(assignment.street || assignment.address)}, ` : ''}${assignment.barangay}, Iligan City` : assignment.address}
                    </Text>
