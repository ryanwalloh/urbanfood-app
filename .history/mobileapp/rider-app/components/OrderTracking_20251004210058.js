...
const OrderTracking = ({ orderId, onBack }) => {
  ...
  // Theme state
  const [theme, setTheme] = useState('night'); // 'night' | 'light'

  // Night Map Style - keep current setup
  const nightMapStyle = [
  ...
  // Light Mode Map Style - provided JSON
  const lightMapStyle = [
    { "elementType": "geometry", "stylers": [{ "color": "#1c2635" }] },
    { "elementType": "labels.text.fill", "stylers": [{ "color": "#9abbd3" }] },
    { "elementType": "labels.text.stroke", "stylers": [{ "color": "#0b1623" }] },
    { "featureType": "administrative", "elementType": "geometry.stroke", "stylers": [{ "color": "#2b3a51" }] },
    { "featureType": "administrative.land_parcel", "stylers": [{ "visibility": "off" }] },
    { "featureType": "poi", "stylers": [{ "visibility": "off" }] },
    { "featureType": "poi.park", "elementType": "geometry.fill", "stylers": [{ "color": "#102c3b" }] },
    ...
    { "featureType": "road", "elementType": "labels.text.fill", "stylers": [{ "color": "#a5b7c8" }] },
    { "featureType": "road.highway", "elementType": "geometry", "stylers": [{ "color": "#F43332" }] },
    { "featureType": "road.highway", "elementType": "geometry.stroke", "stylers": [{ "color": "#b3201f" }] },
    { "featureType": "road.highway", "elementType": "labels.text.fill", "stylers": [{ "color": "#ffd9d8" }] },
    { "featureType": "road.local", "elementType": "labels", "stylers": [{ "visibility": "off" }] },
    { "featureType": "transit", "stylers": [{ "visibility": "off" }] },
    { "featureType": "water", "elementType": "geometry", "stylers": [{ "color": "#0b1e30" }] },
    { "featureType": "water", "elementType": "labels.text.fill", "stylers": [{ "color": "#40627a" }] }
  ];
    ...
    return (
      <View style={styles.content}>
        ...
        <View style={styles.orderNumberContainer}>
          <Text style={[styles.orderNumberLabel, theme === 'night' && styles.orderNumberLabelNight]}>Order No.</Text>
          <Text style={[styles.orderNumberValue, theme === 'night' && styles.orderNumberValueNight]}>#{orderDetails.order_id}</Text>
        </View>
        ...
        {/* Progress Guide */}
        <View style={[styles.progressGuide, theme === 'night' && styles.progressGuideNight]}>
          {/* Pickup Point */}
          <View style={styles.progressItem}>
            ...
            <Text style={[styles.progressTitle, theme === 'night' && styles.progressTitleNight]}>{orderDetails.restaurant_barangay}</Text>
            <Text style={[styles.progressSubtitle, theme === 'night' && styles.progressSubtitleNight]}>Pickup Point</Text>
            </View>
          </View>
          ...
          <View style={styles.progressItem}>
            ...
            <View style={styles.progressTextContainer}>
            <Text style={[styles.progressTitle, theme === 'night' && styles.progressTitleNight]}>{orderDetails.customer_barangay}</Text>
            <Text style={[styles.progressSubtitle, theme === 'night' && styles.progressSubtitleNight]}>Drop Point</Text>
            </View>
          </View>
        </View>

        {/* Delivery Type and Amount */}
        <View style={[styles.deliveryTypeContainer, theme === 'night' && styles.deliveryTypeContainerNight]}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        <MapView
          ...
          customMapStyle={theme === 'night' ? nightMapStyle : lightMapStyle}
          mapType="standard"
        ...
        >
          ...
          {customerLocation && (
            <Marker
              ...
              title="Customer"
              anchor={{ x: 0.5, y: 1 }}
              pinColor={customerMarkerError ? '#2ECC71' : undefined}
        ...
        <TouchableOpacity 
          ...
          onPress={toggleTheme}
        >
          <Text style={styles.controlButtonText}>{theme === 'night' ? '☀️' : '🌙'}</Text>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  orderNumberLabelNight: {
    color: '#A9B2BC',
  },
  orderNumberValueNight: {
    color: '#FFFFFF',
  },
  callingCard: {
    flexDirection: 'row',
