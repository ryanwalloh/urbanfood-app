        ...
        >
            ...
            >
              <View style={styles.markerWrapper} collapsable={false}>
                <Image
                  ...
                  onError={(e) => console.log('Rider marker failed to load', e.nativeEvent)}
                />
              </View>
            </Marker>
          )}
          ...
          {restaurantLocation && (
            <Marker
              ...
              title="Restaurant"
              anchor={{ x: 0.5, y: 1 }}
              tracksViewChanges={!restaurantMarkerLoaded}
            >
              <View style={styles.markerWrapper} collapsable={false}>
                <Image
                  ...
                  onError={(e) => console.log('Restaurant marker failed to load', e.nativeEvent)}
                />
              </View>
            </Marker>
          )}
          ...
          {customerLocation && (
            <Marker
              ...
              title="Customer"
              anchor={{ x: 0.5, y: 1 }}
              tracksViewChanges={!customerMarkerLoaded}
            >
              <View style={styles.markerWrapper} collapsable={false}>
                <Image
                  ...
                  onError={(e) => console.log('Customer marker failed to load', e.nativeEvent)}
                />
              </View>
            </Marker>
          )}
