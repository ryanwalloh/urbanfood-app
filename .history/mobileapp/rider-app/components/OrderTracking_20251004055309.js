  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        ...
        mapHeight.setValue(350 + (progress * (height - 350 - 80))); // Keep 80px for content
        contentHeight.setValue(height - 350 - (progress * (height - 350 - 80)));
      },
      onPanResponderRelease: (evt, gestureState) => {
        ...
        Animated.parallel([
          Animated.spring(mapHeight, {
            toValue: 350 + (progress * (height - 350 - 80)), // Keep 80px for content
            useNativeDriver: false,
            tension: 150,
            friction: 15,
          }),
          Animated.spring(contentHeight, {
            toValue: height - 350 - (progress * (height - 350 - 80)),
            useNativeDriver: false,
            tension: 150,
            friction: 15,
          })
