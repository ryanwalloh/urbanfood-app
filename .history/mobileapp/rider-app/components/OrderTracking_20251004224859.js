  ...
  const renderOrderDetails = () => {
    ...
    return (
      <View style={styles.content}>
        ...
        {(() => {
          console.log('🔍 Rendering proof of delivery info - Status:', orderDetails?.status, 'Image:', !!proofOfDeliveryImage);
          return orderDetails?.status === 'arrived' && proofOfDeliveryImage;
        })() && (
