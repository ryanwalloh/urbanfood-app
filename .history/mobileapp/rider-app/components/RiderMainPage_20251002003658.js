            ...
            {weather && (
              <View style={styles.weatherContainer}>
                <Text style={styles.weatherText}>
                  {weatherService.getWeatherIcon(weather.current.weatherCode)} {weather.current.temperature}<Text style={styles.degreeSymbol}>°</Text><Text style={styles.degreeUnit}>C</Text>
                </Text>
        ...
        <View style={styles.statusContainer}>
          <View style={styles.statusContent}>
            <View style={styles.statusTextContainer}>
              ...
              <Text style={styles.statusSubtitle}>Turn on to receive Delivery Assignments</Text>
            </View>
            <TouchableOpacity 
