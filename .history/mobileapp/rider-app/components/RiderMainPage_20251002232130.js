          ...
          <View style={styles.heroContent}>
            ...
            <View style={styles.mainInfoContainer}>
              <View style={styles.weatherContainer}>
                {weatherLoading ? (
                  <View style={styles.weatherLoadingSkeleton}>
                    <View style={styles.weatherLoadingIcon} />
                    <View style={styles.weatherLoadingText}>
                      <View style={styles.weatherLoadingTemp} />
                      <View style={styles.weatherLoadingDesc} />
                      <View style={styles.weatherLoadingLocation} />
                    </View>
                  </View>
                ) : weather ? (
                  <>
...
const styles = StyleSheet.create({
  ...
  // Weather Loading Skeleton Styles
