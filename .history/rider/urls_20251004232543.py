...
urlpatterns = [
    ...
    path('update-order-with-proof/', views.update_order_with_proof, name='update_order_with_proof'),
    path('get-presigned-upload-url/', views.get_presigned_upload_url, name='get_presigned_upload_url'),
