...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ['id', 'token_number', 'customer_name', 'customer_phone', 'customer_address', 'created_at', 'total_amount', 'rider_name', 'rider_phone', 'items']

    def get_customer_name(self, obj):
        return obj.customer.get_full_name()

    def get_customer_phone(self, obj):
        return obj.customer.customer.phone if hasattr(obj.customer, 'customer') and obj.customer.customer else 'N/A'
