...
class PersonalDetailsForm(forms.ModelForm):
    ...
    phone_number = forms.CharField(max_length=15, required=True, widget=forms.TextInput(attrs={'placeholder': 'Mobile Number', 'class': 'number'}))
    class Meta:
        model = User
        ...
        widgets = {
            ...
            'phone_number': forms.TextInput(attrs={'placeholder': 'Mobile Number', 'class': 'number'})
        }
