...
from menu.models import Order, OrderItem, CartItem 
...
def finalize_order(request):
    if request.method == 'POST':
        ...
        # 1. Retrieve the current cart items of the user
        ...
        order = Order.objects.create(
            customer=request.user.customer,  # assuming you have a Customer profile
